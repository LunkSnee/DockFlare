...
🔧 **Environment variables reference**: See `dockflare/app/templates/docs/Environment-Variables.md` for a full listing of supported environment variables (defaults and descriptions).
