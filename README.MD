...
- **[Environment Variables Reference](dockflare/app/templates/docs/Environment-Variables.md)** - A full listing of supported environment variables (defaults and descriptions).
